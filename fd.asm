...
#ENDIF
#IF (PLATFORM == PLT_SMB_WD)
  #DEFINE 	PLATFORM_NAME	"SMB RC2014 WD"
#ENDIF
...
FDC_DMA		.EQU	05CH		; NOT USED BY SMB_WD
#ENDIF
;
;===============================================================================
...
#IF ((PLATFORM == PLT_ZETA) | (PLATFORM == PLT_DISKIO3))
	AND	00000010B
#ENDIF
#IF ((PLATFORM == PLT_DIDE) | (PLATFORM == PLT_N8) | (PLATFORM == PLT_ZETA2) | (PLATFORM == PLT_SMB_WD))
	AND	11110000B
#ENDIF
	LD	DE,STR_ON
	JP	NZ,FM_DRAW1
